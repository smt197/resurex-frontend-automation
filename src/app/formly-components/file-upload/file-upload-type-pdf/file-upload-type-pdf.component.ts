...
@Component({
  selector: 'vex-file-upload-type-pdf',
  standalone: true,
  imports: [
     FilePondModule,
    MatSelectModule,
  ...
  templateUrl: './file-upload-type-pdf.component.html',
  styleUrl: './file-upload-type-pdf.component.scss'
})
export class FileUploadTypePDFComponent extends FieldType<FieldTypeConfig> {


  extensions: string[] = environment.extensions_files;
  fileFields = [
